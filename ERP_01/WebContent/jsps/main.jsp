	...
	<div class="container">
		<div class="head">
			<div class="head-left">
				...
				<span style="color:#4a940d">${userSession.name }</span>
			</div>
			...
			<div class="left">
				...
				<div class="left-bottom">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td><a class="hei" target="main" href="<%=request.getContextPath()%>/FindEmpListServlet">&nbsp;&nbsp;&nbsp;&nbsp;员工维护</a></td>
							</tr>
							<tr>
				...
				<table width="98%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td width="82%"><img src="../images/icon_1.gif" />&nbsp; <a
							class="lanyo" href="www.itcast.cn">佳音校区 蓝源信息技术 2014</a></td>
